    ...
    private void getProductList(){
        ...
        StringRequest mStringRequest = new StringRequest(Request.Method.POST, API.BASE_URL1+"productlist_of_brand", new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if(status.equals("success")){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            productList.setTitle(CommanMethod.getTitle(ProductListActivity.this, jsonObject2));
                ...
                productListAdapter = new ProductListAdapter(ProductListActivity.this,productListList,userWishlists, number, ProductListActivity.this);
