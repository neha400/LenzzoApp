...
import com.lenzzo.adapter.CategoryAdapter;
    ...
    private void getCategoryList(){
        ...
        StringRequest mStringRequest = new StringRequest(Request.Method.POST, API.BASE_URL+"categorylist", new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                LinearLayoutManager gridLayoutManager = new LinearLayoutManager(CategoryActivity.this, RecyclerView.VERTICAL, false);
                ...
                try {
                    ...
                    if(status.equals("success")){
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            productList.setTitle(CommanMethod.getTitle(CategoryActivity.this, jsonObject2));
