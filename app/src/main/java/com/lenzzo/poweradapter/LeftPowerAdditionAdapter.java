...
public class LeftPowerAdditionAdapter extends RecyclerView.Adapter<LeftPowerAdditionAdapter.MyViewHolder>{
    ...
    public LeftPowerAdditionAdapter(Context ctx, List<PowerModel> powerModelList, String from){
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.power_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((ProductDetailsActivity)context).updateAdditionLeft(position, from);
            }
        });
    }
